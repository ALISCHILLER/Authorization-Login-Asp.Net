...
namespace Authorization_Login_Asp.Net.Infrastructure.Services
{
    ...
    public class TracingService : ITracingService
    {
        ...
        public TracingService(ILogger<TracingService> logger, IOptions<JaegerSettings> settings)
        {
            ...
            _activitySource = new ActivitySource(GetType().Assembly.GetName().Name ?? "Authorization-Login-Service");
        }
        ...
        public void AddTracing(IServiceCollection services)
        {
            try
            {
                services.AddOpenTelemetry()
                    ...
                    {
                        builder
                            .AddSource(GetType().Assembly.GetName().Name ?? "Authorization-Login-Service")
