    ...
    public class RateLimitingMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
                 ...
                 context.Request.Path.StartsWithSegments("/api/auth/register")))
            {
                ...
                var maxAttempts = _configuration.GetValue<int>("Security:RateLimiting:MaxAttempts", 5);
                var windowMinutes = _configuration.GetValue<int>("Security:RateLimiting:WindowMinutes", 15);
